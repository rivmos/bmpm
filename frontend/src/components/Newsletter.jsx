...
const Newsletter = () => {
    ...
    return (
        <div className='max-w-8xl flex flex-col gap-4 md:gap-8 items-center mx-auto py-8 md:py-20' >
            ...
            <div className='text-center'  data-barba="container">
                ...
                <p className='text-xl md:text-2xl'>STAY TUNED FOR OUR UPDATES</p>
            </div>
            <div className='border-[1px]'>
                <input placeholder='Your E-mail ID' className='p-2 w-36 md:w-96' value={form.email} onChange={(e) => { setForm({ ...form, email: e.target.value }) }} />
            ...
            <div className='flex justify-center gap-1 items-center'>
                ...
                <span className='text-sm md:text-base'>I have read and agree to the Terms & Conditions</span>
            </div>
        </div>
    )
}
